...
footsteps of the Leakeys \parencite{Koff1997}. \textcite{Schmidt,1995} has
...
The replacement model, better known as the ``out-of-Africa~\RN{2}'' hypothesis,
proposes that \emph{H. sapiens} originated exclusively in Africa and spread to
Eurasia recently. This wave of emigration drove the already-present Eurasian
\emph{Homo} populations, who had migrated nearly a million years beforehand in
``out-of-Africa~\RN{1},'' to extinction, ``replacing'' them. In the 1980s,
paleoanthropologists accepted the idea of \emph{H. sapiens} appearing around
.2~Ma and rapidly spreading outside Africa, completely replacing populations
of hominins without any population mixture \parencite{Kendrick2014}.
