...
\section{I Am A Trolling Genious, lolz}

\AN[Disclaimer: ]{I do not own the HP series and I am not the real XXXbloodyrists666XXX.}

\AN[\textlcsc{AN}// ]{I am an extremely immature pathetic idiot girl, I know. Out of boredom, I crack this girl's passy for fun (and it took less than 8 minutes to do it too) and will probably get in a shitload of trouble. Which I probably deserve 'cause I'm being a troll right now. Meh.
...
\begin{sloppypar}
    All the silly goth clothes dropped from everyone's bodies (\AN[\textlcsc{AN}//]{I will refuse to explain how the hell that happened.}) and, in their place, clothes the characters would normally wear in canon appeared on their bodies.
\end{sloppypar}
...
\AN[\textlcsc{AN}// ]{Oh yeah, if you wanna see the original content this chick had planned for this chapter, I accessed it through the document manager thingy, which I copied and pasted, so you can read it here:}
